...
/*	$mysqli = mysqli_connect('localhost','root','','bookstore'); 
    ...
    if(mysqli_num_rows($result) <> 0)
    {
        ...
        {   
            echo "<tr>";
            echo "<td>";             
            echo '<img src ="../images/arrow.png" >  <a href="gia_home.php?matheloai='.$row['MaTheLoai'].'"> '.$row['Gia'].'</a></font>';
            echo "</br>";
            echo "</td>"; 
            echo "</tr>";      
        }  
...
?>
 ...
 <?php
    ...
    // Tìm tổng số dOng với câu lệnh truy vấn
        ...
        $query = mysqli_query( $mysqli , "SELECT * FROM sach WHERE Gia <= 50");
        ...
        $sql = "SELECT * FROM sach WHERE Gia <= 50 limit ".$start.",".$limit ;
